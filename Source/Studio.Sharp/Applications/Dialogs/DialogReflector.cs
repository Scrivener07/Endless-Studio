...
namespace Sharp.Applications.Dialogs
{
	...
	/// </summary>
	/// <example>var r = new Reflector("System.Windows.Forms");</example>
	public class DialogReflector
	{
		...
		/// <summary>
		/// Constructor presents a 'vista' dialog box to select folders.
		/// </summary>
		/// <param name="ns">The namespace containing types to be used</param>
		public DialogReflector(string ns) : this(ns, ns)
		{
			// constructor
		}
		...
		/// <param name="ns">The namespace containing types to be used</param>
		public DialogReflector(string an, string ns)
		{
			m_ns = ns;
			m_asmb = null;
